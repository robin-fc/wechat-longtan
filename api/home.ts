...
const entriesMock: HomeEntryItem[] = [
  {
    id: 'entry-photo',
    name: '摄影漫游',
    icon: { id: 'entry-photo-icon', url: '/preference/首页.png' },
  ...
  },
  {
    id: 'entry-homestay',
    name: '龙潭民宿',
    icon: { id: 'entry-homestay-icon', url: '/preference/民宿列表.png' },
    type: 'homestay',
    value: 'all',
  },
]
